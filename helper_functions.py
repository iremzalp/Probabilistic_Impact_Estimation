...
class Helper:
    ...
    def save_weather(self, REFIT_dir = '../data/', house_id = 3, EXPORT_PATH = '../export/'):
        #iö changed range from 1,4 to 1,22
    ...
    def create_day_ahead_prices_df(self, FILE_PATH, filename):
      ...
      #electricity_prices["MTU (UTC)"] = electricity_prices["MTU (UTC)"].str.split(pat = "-", n = 0).str[0]
      #electricity_prices.columns = ["Time", "Price"]
      #lectricity_prices = electricity_prices.set_index(pd.DatetimeIndex(electricity_prices['Time']), drop = True)
      #electricity_prices = electricity_prices["Price"]
      #return electricity_prices
